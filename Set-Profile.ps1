...
(New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/dgowdy/Azure/master/Set-Profile.ps1') | 
  Set-Content $profile -Force
#>

$profilePath = 'https://raw.githubusercontent.com/dgowdy/Azure/master/profile.ps1'
